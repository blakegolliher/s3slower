...
// DropCallback is invoked whenever an event is dropped either at the kernel
// perf ring (LostSamples > 0) or when the userspace channel is full. Runner
// wires this to the Prometheus events_dropped_total counter.
