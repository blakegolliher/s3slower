...
// MetricsConfig controls the Prometheus metric label set. The label set
// is deliberately narrow by default (comm + s3_operation) to keep
// cardinality bounded. High-cardinality labels are opt-in via Labels.
